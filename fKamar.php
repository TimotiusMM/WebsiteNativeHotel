...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Validate inputs
    if (empty($_POST['roomType']) || empty($_POST['roomFasilitas'])) {
        ...
        $sql = "INSERT INTO fkamar (tipe_kamar, fasilitas) VALUES ('$roomType', '$roomFasilitas')";
...
<body>
        ...
        <div class="container mt-4">
            ...
            <div class="col-md-12">
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        <?php
                        $result = $koneksi->query("SELECT * FROM fkamar");
    ...
    <td>' . $row['fasilitas'] . '</td>
    <td>
        <a href="editFkamar.php?no=' . $row['no'] . '" class="btn btn-warning">Edit</a>
